...
#ln -s linux-beagle-xm_from_vasya/linux-beagle-xm/ linux
#ln -s linux-3.2.51/ linux
#ln -s linux-3.0.1/ linux

set -e

#export PATH=$PATH:$(pwd -P)/u-boot/tools
export PATH=$PATH:$(pwd -P)/../../U-Boot/u-boot/tools
...
export CROSS_COMPILE=$(pwd -P)/../../Compilers/arm-2010q1-202/bin/arm-none-linux-gnueabi-
is_zImage=0
